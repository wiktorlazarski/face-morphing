...
class FaceMorphingPipeline:
    def __init__(
        ...
        nn_image_input_resolution: int = 256
    ):
        ...
        self._model = mdl.KeyPointsModel.load_from_checkpoint(
    ...
    def _postprocess_model_output(
        ...
        preprocessed_image_shape: t.Tuple[int, int], top_left_face_pointsce_points: t.Tuple[int, int]
    ) -> np.ndarray:
        out = out.squeeze()
